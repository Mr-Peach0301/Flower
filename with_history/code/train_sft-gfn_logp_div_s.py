...
class EvaluateCallback(TrainerCallback):
    def __init__(self, test_data_path, category, info_file, group_title_path, tokenizer, temperature, logits_file=None, title_token_distribution=None, possible_output=None, gfn_theta=0.9, train_theta=0.999):
        ...
        self.path = f'./temp_sft&gfn_logp_div_s/{self.category}_base/final_result.json'
        self.result_data = f'./temp_sft&gfn_logp_div_s/{self.category}_base'
...
class MyTrainer(Trainer):
    def __init__(self, tokenizer, min_sentence_len, max_sentence_len, group_title_path, title_token_distribution, possible_output, gfn_theta, train_theta, sasrec_logits, info_file, *args, **kwargs):
