...
do
    ...
    do
        ...
        do
            ...
            CUDA_VISIBLE_DEVICES=6 nohup python ./code/train_sft-gfn_logp_add_logs.py > ./out_sft-gfn/${category}_${train_theta}_${gfn_theta}_${S_lamda}_logp_add_logs.out \
                --base_model YOUR_MODEL_PATH \
                --train_file ${train_file} \
                --eval_file ${eval_file} \
                --output_dir ../output_dir_sft-gfn_logp_add_logs/${category}_${start_year} \
                --category ${category}  \
                --min_sentence_len 1 \
