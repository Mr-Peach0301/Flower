...
do
    ...
    echo ${train_file} ${test_file} ${info_file} ${eval_file} ${group_title}
    CUDA_VISIBLE_DEVICES=1 nohup python ./code/train_sft.py  > ./out_sft-gfn/${category}_sft.out \
        --base_model YOUR_MODEL_PATH \
        --train_file ${train_file} \
        --eval_file ${eval_file} \
        --output_dir ../output_dir_sft/${category}_${start_year} \
        --category ${category}  \
